<template>
  <div>
    ...
    <div class="row justify-content-center padding-sm-x">
      <div class="col-12">
        <Settings v-if="!isSettingComplete" :progress="'28.57%'" :is-active-setting-email="true" :is-active-setting-branch="true" />
        <Settings
          v-else
          :progress="'100%'"
...
import Branches from '~/components/Settings/Branches/index.vue';
...
@Component({
  ...
  middleware: ['auth', 'branchSetting', 'GeneralManager'],
  layout: 'Admin'
})
